...
def make_requests_for_production(document, clientPosition, servingParty):
  requestsForProductionArray = [
    "All documents identified, directly or indirectly, in your answers to Interrogatories.",
    "All written reports of all expert witnesses with whom you or your attorneys have consulted, including, of course, those persons you expect to call as an expert witness at trial.",
    ...
    "All notes, correspondence, bills, invoices, diagrams, photographs, or other documents prepared or reviewed by each person whom you expect to call as an expertwitness at trial.",
    ...
    "Any documents which afforded, descirbed or pertained to liability insurance coverage for the occurrences which are the subject matter of the complaint.",
