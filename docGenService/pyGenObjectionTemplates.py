...
def make_fl_gen_obj(document, clientPosition, servingParty):
    objectionsArray = [
        ...
        f"{clientPosition} objects to any and all requests to the extent they seek or may be interpreted to seek disclosure of any information which (a) is subject to the attorney-client privilege; (b) or subject to the 'work product' doctrine; (c) is subject to the self-critical analysis privilege; (d) is subject to the required reports privilege; (e) is subject to a joint defense or common interest privilege; (f) was generated in anticipation of litigation or for trial by or for {clientPosition} or any representatives of {clientPosition} including attorneys, consultants or agents; (g) relates to the identity or opinions of consultants or experts retained or employed in anticipation of litigation and who are not expected to be called as witnesses at trial; (h) is protected as a trade secret; (i) is subject to a protective order or confidentiality order or agreement  entered  in another matter, to the extent the same prevents disclosure in this matter; and/or (j) is otherwise privileged, protected from disclosure, or beyond the scope of discovery under applicable rules and laws. {clientPosition} does not intend to disclose or produce any such information in response to the request being answered.  Any disclosure of information which is privileged or otherwise protected from disclosure is inadvertent. All rights to demand return or destruction of such information are reserved.",
        f"{clientPosition} objects to the propounding parties' requests insofar as they seek a proposition of law and/or the formulation of a legal theory, or seek contentions regarding factual matters as to which essential discovery is incomplete. {clientPosition}'s current responses to such requests necessarily cannot present all information {clientPosition} may ultimately discover and utilize or rely upon in this matter. {clientPosition} thus reserves all rights to supplement or amend its responses in accordance with applicable rules, laws, orders or agreements of the parties as circumstances may warrant.",
    ]
    print(
