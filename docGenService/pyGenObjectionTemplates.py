...
def make_ny_gen_obj(document, clientPosition, servingParty):
    objectionsArray = [
        ...
        f"{clientPosition} further objects to any and all requests to the extent they seek or may be interpreted to seek disclosure of information not within the scope of New York CPLR 3120, 3130 - 33, or not within the scope of what is permitted under any applicable Preliminary Conference or Case Scheduling Order entered in this case, and [party] reserves all rights to contest any such matters in any other context or proceeding where they may be relevant.",
