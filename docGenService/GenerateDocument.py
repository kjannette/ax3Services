...
class GenerateBody(object):
    def generate(self, docId):
        ...
        foundationRogArray = [
            ...
            "Identify all insurance carriers or self-insured funds, by name, address, policy numbers and policy limits, for any insurance policy or fund which may provide coverage for any judgment entered against you related to this occurrence.",
